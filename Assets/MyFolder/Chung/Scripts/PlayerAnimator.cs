...
public class PlayerAnimator : MonoBehaviourPun
{
    ...
    [SerializeField][Range(0f, 1f)] private float rollVolume = 0.8f;      // 구르기 볼륨
    [SerializeField][Range(0f, 1f)] private float stunVolume = 1.0f;      // 스턴 볼륨
    [SerializeField][Range(0f, 1f)] private float deathVolume = 1.0f;     // 사망 볼륨
    [SerializeField][Range(0f, 1f)] private float weaponSwapVolume = 0.7f;// 무기 교체 볼륨
